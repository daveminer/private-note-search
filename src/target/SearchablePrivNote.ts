...
export const SearchablePrivNoteContractArtifact = loadContractArtifact(SearchablePrivNoteContractArtifactJson as NoirCompiledContract);
...
export class SearchablePrivNoteContract extends ContractBase {
  ...
  public static async at(
    ...
    return Contract.at(address, SearchablePrivNoteContract.artifact, wallet) as Promise<SearchablePrivNoteContract>;
  }
  ...
  public static deploy(wallet: Wallet, admin: AztecAddressLike, name: string, symbol: string, decimals: (bigint | number)) {
    return new DeployMethod<SearchablePrivNoteContract>(Point.ZERO, wallet, SearchablePrivNoteContractArtifact, SearchablePrivNoteContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, admin: AztecAddressLike, name: string, symbol: string, decimals: (bigint | number)) {
    return new DeployMethod<SearchablePrivNoteContract>(publicKey, wallet, SearchablePrivNoteContractArtifact, SearchablePrivNoteContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof SearchablePrivNoteContract['methods']>(
    opts: { publicKey?: PublicKey; method?: M; wallet: Wallet },
    ...args: Parameters<SearchablePrivNoteContract['methods'][M]>
  ) {
    return new DeployMethod<SearchablePrivNoteContract>(
      opts.publicKey ?? Point.ZERO,
      opts.wallet,
      SearchablePrivNoteContractArtifact,
      SearchablePrivNoteContract.at,
