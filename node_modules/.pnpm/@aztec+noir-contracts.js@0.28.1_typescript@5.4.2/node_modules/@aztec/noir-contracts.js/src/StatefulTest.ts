...
export class StatefulTestContract extends ContractBase {
  ...
  public methods!: {
    ...
    public_constructor: ((owner: AztecAddressLike, value: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;

    /** create_note_no_init_check(owner: struct, value: field) */
    create_note_no_init_check: ((owner: AztecAddressLike, value: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
