...
export declare class ParentContract extends ContractBase {
    ...
    methods: {
        ...
        /** privateCall(targetContract: struct, targetSelector: struct, args: array) */
        privateCall: ((targetContract: AztecAddressLike, targetSelector: FunctionSelectorLike, args: FieldLike[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        ...
        /** publicNestedStaticCall(targetContract: struct, targetSelector: struct, args: array) */
        publicNestedStaticCall: ((targetContract: AztecAddressLike, targetSelector: FunctionSelectorLike, args: FieldLike[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** enqueueStaticNestedCallToPubFunction(targetContract: struct, targetSelector: struct, args: array) */
        enqueueStaticNestedCallToPubFunction: ((targetContract: AztecAddressLike, targetSelector: FunctionSelectorLike, args: FieldLike[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** compute_note_hash_and_nullifier(contract_address: struct, nonce: field, storage_slot: field, note_type_id: field, serialized_note: array) */
        compute_note_hash_and_nullifier: ((contract_address: AztecAddressLike, nonce: FieldLike, storage_slot: FieldLike, note_type_id: FieldLike, serialized_note: FieldLike[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** privateStaticCallNested(targetContract: struct, targetSelector: struct, args: array) */
        privateStaticCallNested: ((targetContract: AztecAddressLike, targetSelector: FunctionSelectorLike, args: FieldLike[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
