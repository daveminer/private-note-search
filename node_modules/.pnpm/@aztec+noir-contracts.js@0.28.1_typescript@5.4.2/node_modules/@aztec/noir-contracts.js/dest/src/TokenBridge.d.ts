...
export declare class TokenBridgeContract extends ContractBase {
    ...
    methods: {
        ...
        /** claim_public(to: struct, amount: field, canceller: struct, secret: field) */
        claim_public: ((to: AztecAddressLike, amount: FieldLike, canceller: EthAddressLike, secret: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        ...
        /** claim_private(secret_hash_for_redeeming_minted_notes: field, amount: field, canceller: struct, secret_for_L1_to_L2_message_consumption: field) */
        claim_private: ((secret_hash_for_redeeming_minted_notes: FieldLike, amount: FieldLike, canceller: EthAddressLike, secret_for_L1_to_L2_message_consumption: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
