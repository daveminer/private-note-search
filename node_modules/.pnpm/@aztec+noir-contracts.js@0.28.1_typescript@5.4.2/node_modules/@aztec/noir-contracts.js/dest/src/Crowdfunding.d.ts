...
export declare class CrowdfundingContract extends ContractBase {
     ...
     */
    static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, donation_token: AztecAddressLike, operator: AztecAddressLike, deadline: bigint | number): DeployMethod<CrowdfundingContract>;
    /**
    ...
    methods: {
        ...
        constructor: ((donation_token: AztecAddressLike, operator: AztecAddressLike, deadline: bigint | number) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
