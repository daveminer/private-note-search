...
export declare class TestContract extends ContractBase {
    ...
    methods: {
        ...
        /** consume_mint_private_message(secret_hash_for_redeeming_minted_notes: field, amount: field, canceller: struct, secret_for_L1_to_L2_message_consumption: field) */
        consume_mint_private_message: ((secret_hash_for_redeeming_minted_notes: FieldLike, amount: FieldLike, canceller: EthAddressLike, secret_for_L1_to_L2_message_consumption: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        ...
        /** consume_mint_public_message(to: struct, amount: field, canceller: struct, secret: field) */
        consume_mint_public_message: ((to: AztecAddressLike, amount: FieldLike, canceller: EthAddressLike, secret: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** consume_message_from_arbitrary_sender_public(content: field, secret: field, sender: struct) */
        consume_message_from_arbitrary_sender_public: ((content: FieldLike, secret: FieldLike, sender: EthAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    };
}
