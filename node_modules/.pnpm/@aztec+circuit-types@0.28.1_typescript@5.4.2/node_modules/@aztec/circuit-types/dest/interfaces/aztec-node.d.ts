...
export interface AztecNode {
     ...
     */
    getNullifierSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof NULLIFIER_TREE_HEIGHT>>;
    /**
     ...
     * @returns The sibling path for the leaf index.
     */
    getNoteHashSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof NOTE_HASH_TREE_HEIGHT>>;
    /**
     ...
     */
    getL1ToL2MessageSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof L1_TO_L2_MSG_TREE_HEIGHT>>;
    /**
     ...
     */
    getL2ToL1MessageIndexAndSiblingPath(blockNumber: number | 'latest', l2ToL1Message: Fr): Promise<[number, SiblingPath<number>]>;
    /**
     ...
     * @returns The sibling path.
     */
    getPublicDataSiblingPath(blockNumber: BlockNumber, leafIndex: bigint): Promise<SiblingPath<typeof PUBLIC_DATA_TREE_HEIGHT>>;
    /**
