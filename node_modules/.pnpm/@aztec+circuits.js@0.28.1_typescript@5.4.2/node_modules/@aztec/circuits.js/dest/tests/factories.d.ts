...
import { AggregationObject, AppendOnlyTreeSnapshot, BaseOrMergeRollupPublicInputs, BaseParityInputs, BaseRollupInputs, CallContext, CallRequest, CallerContext, CombinedAccumulatedData, CombinedConstantData, ConstantRollupData, ContractStorageRead, ContractStorageUpdateRequest, Fr, FunctionSelector, GrumpkinPrivateKey, L2ToL1Message, MembershipWitness, MergeRollupInputs, NoteHashReadRequestMembershipWitness, ParityPublicInputs, PartialStateReference, Point, PreviousRollupData, PrivateAccumulatedNonRevertibleData, PrivateAccumulatedRevertibleData, PrivateCallData, PrivateCallStackItem, PrivateCircuitPublicInputs, PrivateKernelInnerCircuitPublicInputs, PrivateKernelInnerData, PrivateKernelTailCircuitPublicInputs, Proof, PublicAccumulatedNonRevertibleData, PublicAccumulatedRevertibleData, PublicCallData, PublicCallRequest, PublicCallStackItem, PublicCircuitPublicInputs, PublicDataRead, PublicDataTreeLeaf, PublicDataTreeLeafPreimage, PublicDataUpdateRequest, PublicKernelCircuitPrivateInputs, PublicKernelCircuitPublicInputs, PublicKernelData, RootParityInput, RootParityInputs, RootRollupInputs, RootRollupPublicInputs, SideEffect, SideEffectLinkedToNoteHash, StateDiffHints, StateReference, TxContext, TxRequest, VerificationKey } from '../index.js';
 ...
 */
export declare function makeNewSideEffect(seed: number): SideEffect;
/**
 * Creates an arbitrary side effect object (linked to a note hash) with the given seed.
 * @param seed - The seed to use for generating the object.
 * @returns A side effect object.
 */
export declare function makeNewSideEffectLinkedToNoteHash(seed: number): SideEffectLinkedToNoteHash;
/**
 ...
 * @returns An accumulated data.
 */
export declare function makeCombinedAccumulatedRevertibleData(seed?: number, full?: boolean): PublicAccumulatedRevertibleData;
/**
...
export declare function makeCombinedAccumulatedNonRevertibleData(seed?: number, full?: boolean): PublicAccumulatedNonRevertibleData;
/**
 ...
 * @returns Public kernel circuit public inputs.
 */
export declare function makeRollupKernelCircuitPublicInputs(seed?: number, fullAccumulatedData?: boolean): RollupKernelCircuitPublicInputs;
/**
 * Creates arbitrary private kernel inner circuit public inputs.
 * @param seed - The seed to use for generating the kernel circuit public inputs.
 * @returns Private kernel circuit public inputs.
 */
export declare function makePrivateKernelInnerCircuitPublicInputs(seed?: number, full?: boolean): PrivateKernelInnerCircuitPublicInputs;
/**
 ...
 */
export declare function makeNoteHashReadRequestMembershipWitness(start: number): NoteHashReadRequestMembershipWitness;
/**
 ...
 */
export declare function makeEmptyNoteHashReadRequestMembershipWitness(): NoteHashReadRequestMembershipWitness;
/**
 ...
 */
export declare function makeGrumpkinPrivateKey(seed?: number): GrumpkinPrivateKey;
/**
 ...
 * @returns A previous kernel data.
 */
export declare function makeRollupKernelData(seed?: number, kernelPublicInputs?: RollupKernelCircuitPublicInputs): RollupKernelData;
/**
 ...
 * @returns A previous kernel data.
 */
export declare function makePrivateKernelInnerData(seed?: number, inputs?: PrivateKernelInnerCircuitPublicInputs): PrivateKernelInnerData;
/**
 ...
 */
export declare function makePrivateKernelInitCircuitPrivateInputs(seed?: number): PrivateKernelInitCircuitPrivateInputs;
/**
 * Makes arbitrary private kernel inner private inputs
 * @param seed - The seed to use for generating the private kernel inputs.
 * @returns Private kernel inner private inputs.
 */
export declare function makePrivateKernelInnerCircuitPrivateInputs(seed?: number): PrivateKernelInnerCircuitPrivateInputs;
/**
 ...
 * @returns Public kernel inputs.
 */
export declare function makePublicKernelInputsWithTweak(seed?: number, tweak?: (publicKernelInputs: PublicKernelCircuitPrivateInputs) => void): PublicKernelCircuitPrivateInputs;
/**
...
export declare function makeRootParityInput(seed?: number): RootParityInput;
...
export declare function makeContractClassPublic(seed?: number): ContractClassPublic;
/**
