...
export declare class RootRollupInputs {
    ...
    static getFields(fields: FieldsOf<RootRollupInputs>): readonly [[PreviousRollupData, PreviousRollupData], RootParityInput, [Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr], [Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr], AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, [Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr, Fr]];
}
/**
...
export declare class RootRollupPublicInputs {
    ...
    /** Hash of the L1 to L2 messages. */
    l1ToL2MessagesHash: [Fr, Fr]);
    static getFields(fields: FieldsOf<RootRollupPublicInputs>): readonly [AggregationObject, AppendOnlyTreeSnapshot, Header, [Fr, Fr]];
    toBuffer(): Buffer;
